...
Unlike conventional sorting algorithms that rearrange elements, 
Stalin Sort solves the problem of disorder radically: any element that violates the ascending order 
is shot and removed from the list.

Task
Implement the function stalin_sort / stalinSort, which accepts an array of integers and modifies
it in-place, removing all elements that violate the ascending order relative to the previous
surviving element.
